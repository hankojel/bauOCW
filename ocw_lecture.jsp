...
<!--
                <div class="list-select">
                    <div class="ui internally celled stackable three column grid">
                        <div class="column scrollbar">
                            <div class="ui middle aligned divided list">
                                <a class="item checked">전체(8)</a>
                                <a class="item">전공별(5)</a>
                                <a class="item">테마별(3)</a>
                                <a class="item">대상자별(3)</a>
                                <a class="item">형태별(3)</a>
                            </div>
                        </div>
                        <div class="column scrollbar">
                            <div class="ui middle aligned divided list">
                                <a class="item">주제별(8)</a>
                                <a class="item">인문학(8)</a>
                                <a class="item checked">교육학(5)</a>
                                <a class="item">생명학(3)</a>
                                <a class="item">사회과학(2)</a>
                                <a class="item">공학(7)</a>
                                <a class="item">인문과학(6)</a>
                            </div>
                        </div>
                        <div class="column scrollbar">
                            <div class="ui middle aligned divided list">
                                <a class="item">테마별(2)</a>
                                <a class="item">중세문학(2)</a>
                                <a class="item checked">고전문학(3)</a>
                            </div>
                        </div>
                    </div>
                </div>
...
-->
            ...
            <div id="container" class="sub-content">
                <h3 class="tit_page"><strong>강좌목록</strong></h3>
                <div class="ui segment lecture-list">
                    <div class="ui items mb0">
                        <div class="item m0">
                            <div class="image">
                                <img src="img/wide-image.png">
                                <a href="#0" class="ui blue fluid button mt5">관심강좌 등록하기</a>
                            </div>
                            <div class="content">
                                ...
                                <div class="ui grid">
                                    ...
                                    <div class="ten wide tablet ten wide computer column tablet computer only">
                                        <div class="ui placeholder segment mt0">공유경제' 소유에 익숙한 자본주의 경제체제와는 대비되는 개념이다. 공유를 활용하면 소유보다 더욱 경제적이고 환경에도 이롭다.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="item m0">
                            ...
                            <div class="content">
                                ...
                                <div class="ui grid">
                                    ...
                                    <div class="ten wide tablet ten wide computer column tablet computer only">
                                        <div class="ui placeholder segment mt0">물론 히어로 이미지를 디자인하고 선택하는 일은 어렵습니다. 과학적이면서도 예술적인 감각이 필요하기 때문입니다.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
